  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="w-full my-0 px-0 py-[10px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch w-full lg:min-h-[70vh]">
          {/* Left side - Image */}
          <div className="relative flex h-full transition-transform">
            <Image
              src="https://22527425.fs1.hubspotusercontent-na2.net/hubfs/22527425/SmiForce/Screenshot%202025-10-30%20at%2012.57.03%20PM.png"
          ...
          {/* Right side - Content */}
          <div className={`space-y-5 lg:space-y-6 xl:space-y-8 flex flex-col h-full pl-[10px] pr-[10px] lg:pl-0 lg:pr-0 ${showForm ? "pt-0 lg:pt-0 lg:justify-center" : "pt-10 justify-start lg:justify-start"}`}>
            {!showForm && (
              <>
                <h1 className="text-2xl lg:text-[28px] xl:text-3xl font-bold leading-tight">
                  Empower Your <span className="text-[#C4342B]">Cybersecurity</span> with
                  <span className="text-[#C4342B]"> SmiForce's AI‑Driven Insights</span>
                </h1>

                <p className="text-base lg:text-[17px] xl:text-lg text-gray-700 leading-relaxed">
                  Leverage SmiForce's AI‑driven solution to enhance IT observability, detect threats early,
                  and optimize response efforts. Download the solution brief to learn how our advanced
                  analytics can streamline security operations and provide unmatched visibility across your
                  environment.
                </p>
            ...
            {showForm && (
              <Card className="w-full h-auto -mt-10 sm:mt-0 mb-[10px] border border-gray-200 shadow-md flex flex-col">
